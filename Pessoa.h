...
//criando um protocolo, dando um nome a ele, neste caso Currasqueiro
@protocol Churrasqueiro <NSObject>

//definindo quais metodos que a classe que receber esse protocolo deve implementar em se arquivo.m
@required
//metodos que obrigatoriamente a classe protocolada deve implementar
-(void)acenderChurraqueira;

@optional
//metodos que opcionalmente a classe protocolada deve implementar
-(void)temperarCarne;
